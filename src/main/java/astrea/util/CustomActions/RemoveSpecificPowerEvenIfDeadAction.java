...
public class RemoveSpecificPowerEvenIfDeadAction extends AbstractGameAction {
    private String powerToRemove;
    private AbstractPower powerInstance;
    private static final float DURATION = 0.1F;

    public RemoveSpecificPowerEvenIfDeadAction(AbstractCreature target, AbstractCreature source, String powerToRemove) {
    ...
    public RemoveSpecificPowerEvenIfDeadAction(AbstractCreature target, AbstractCreature source, AbstractPower powerInstance) {
        this.setValues(target, source, this.amount);
        this.actionType = ActionType.DEBUFF;
        this.duration = 0.1F;

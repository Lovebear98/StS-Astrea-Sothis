...
package astrea.util.CustomActions.CustomGameEffects.vfx;
...
public class ReliefFireEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    private TextureAtlas.AtlasRegion img;

    public ReliefFireEffect(float x, float y) {
        ...
        this.scale = Settings.scale * MathUtils.random(1.0F, 2.0F);// 31

package astrea.cards.generated.Mechanics;
...
public class Chanting extends AbstractAstreaCard {
    public static final String[] EXTENDED_DESCRIPTION = CardStrings.getMockCardString().EXTENDED_DESCRIPTION;

    public static final String ID = makeID(Chanting.class.getSimpleName());

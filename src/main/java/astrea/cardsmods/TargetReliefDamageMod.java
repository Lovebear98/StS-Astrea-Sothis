...
public class TargetReliefDamageMod extends AbstractCardModifier{

    ///Its identifier is done here so we can link straight to it and avoid typing it by hand!
    public static final String CardModID = makeID(TargetReliefDamageMod.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(makeID(TargetReliefDamageMod.class.getSimpleName()));

    public TargetReliefDamageMod(){}
    @Override
    ...
    public AbstractCardModifier makeCopy() {
        return new TargetReliefDamageMod();
    }

...
public class PlayerReliefDamageMod extends AbstractCardModifier{

    ///Its identifier is done here so we can link straight to it and avoid typing it by hand!
    public static final String CardModID = makeID(PlayerReliefDamageMod.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(makeID(PlayerReliefDamageMod.class.getSimpleName()));

    public PlayerReliefDamageMod(){}
    @Override
    ...
    public AbstractCardModifier makeCopy() {
        return new PlayerReliefDamageMod();
    }

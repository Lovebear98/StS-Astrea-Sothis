...
public class AppliedChantingDamageMod extends AbstractCardModifier{
    ...
    public AbstractCardModifier makeCopy() {
        return new AppliedChantingDamageMod();
    }
